...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { content: @information.content, date: @information.date, place: @information.place, title: @information.title, type: @information.type, user_id: @information.user_id }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { content: @information.content, date: @information.date, place: @information.place, title: @information.title, type: @information.type, user_id: @information.user_id }
    assert_redirected_to information_path(assigns(:information))
  end
